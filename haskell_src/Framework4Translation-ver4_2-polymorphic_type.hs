...
unsafe_unbox__TRY__UFile8Data u__dat_D_6Z@(TRY__mkFile datD5u_vmZ) = datD5u_vmZ
    --(TRY__mkFile datD5u_vmZ) = u__dat_D_6Z
...
instance Translation_Hierarchy TRY__hr where
    ...
    load_fl_999 vm_Z_996 dat_D_6Z = dat_D_999 where
        ...
        datD5u_vmZ = unsafe_unbox__TRY__UFile8Data u__dat_D_6Z
          --(TRY__mkFile datD5u_vmZ) = u__dat_D_6Z
        datD = datD5u_vmZ u__vm_Z_999
        dat_D_999 = Mk_Label datD
