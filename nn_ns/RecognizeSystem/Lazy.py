...
'''
modification should be made to seed.util_class.Lazy instead of this file
this file is here to make RecognizeSystem package self-complete
'''
...
try:
    # above definition of Lazy is old
    from seed.util_class.Lazy import Lazy
except ImportError:
    pass
