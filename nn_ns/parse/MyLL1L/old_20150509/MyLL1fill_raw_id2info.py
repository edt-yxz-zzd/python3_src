...
from root.graph_data.directed_acyclic_graph import \
     reversed_topological_ordering, dedges2u2vtc, \
     find_a_circle, NotDAGError
from MyLL1InfoID import FOLLOW, FIRST
...
if __name__ == '__main__':
    ...
    result1_InfoDict = gen_MyLL1_raw_id2info()
    tIDDict, id2info = fill_raw_id2info(result1_InfoDict)
