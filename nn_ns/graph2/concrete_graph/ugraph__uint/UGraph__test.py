...
class sorted_nonempty_vertex_degrees:
    r'''
...
class is_ugraph_rigid_connected:
    r'''
>>> nothing_ugraph.calc.is_ugraph_rigid_connected
False
>>> one_vertex_edgeless_ugraph.calc.is_ugraph_rigid_connected
True
>>> one_vertex_one_loop_ugraph.calc.is_ugraph_rigid_connected
True
>>> one_vertex_two_loops_ugraph.calc.is_ugraph_rigid_connected
True
>>> two_vertices_edgeless_ugraph.calc.is_ugraph_rigid_connected
False
>>> two_vertices_one_nonloop_ugraph.calc.is_ugraph_rigid_connected
True
>>> two_vertices_two_parallel_nonloops_ugraph.calc.is_ugraph_rigid_connected
True
>>> three_vertices_two_nonparallel_nonloops_ugraph.calc.is_ugraph_rigid_connected
True
>>> three_vertices_three_nonparallel_nonloops_ugraph.calc.is_ugraph_rigid_connected
True

'''


class is_ugraph_utree:
    r'''
>>> nothing_ugraph.calc.is_ugraph_utree
False
>>> one_vertex_edgeless_ugraph.calc.is_ugraph_utree
True
>>> one_vertex_one_loop_ugraph.calc.is_ugraph_utree
False
>>> one_vertex_two_loops_ugraph.calc.is_ugraph_utree
False
>>> two_vertices_edgeless_ugraph.calc.is_ugraph_utree
False
>>> two_vertices_one_nonloop_ugraph.calc.is_ugraph_utree
True
>>> two_vertices_two_parallel_nonloops_ugraph.calc.is_ugraph_utree
False
>>> three_vertices_two_nonparallel_nonloops_ugraph.calc.is_ugraph_utree
True
>>> three_vertices_three_nonparallel_nonloops_ugraph.calc.is_ugraph_utree
False
