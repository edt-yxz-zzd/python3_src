...
ImmutableNamespace(aedge2maybe_upper_hedge=(1, 2), depth2depth_idx2vertex=((1,), (0, 2)), depth2vertices1=((1,), (0, 2)), either_root=(False, 1), vertex2child_aedges=((), (1, 2), ()), vertex2depth=(1, 0, 1), vertex2depth_idx=(0, 0, 1), vertex2maybe_parent_aedge=(0, None, 1), vertex2maybe_parent_vertex=(1, None, 1))
