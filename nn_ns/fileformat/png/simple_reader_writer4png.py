...
[[
%s/script\.png\.simple_reader_writer4png/nn_ns.fileformat.png.simple_reader_writer4png/g
]]
...
nn_ns.fileformat.png.simple_reader_writer4png
py -m nn_ns.app.debug_cmd   nn_ns.fileformat.png.simple_reader_writer4png -x # -off_defs
py -m nn_ns.app.doctest_cmd nn_ns.fileformat.png.simple_reader_writer4png:__doc__ -ht # -ff -df
py_adhoc_call  seed.helper.print_methods  @wrapped_print_methods   %nn_ns.fileformat.png.simple_reader_writer4png:cls@T    =T   +exclude_attrs5listed_in_cls_doc
#######
from seed.pkg_tools.ModuleReloader import mk_doctestXmodule_reloader_
doctestXmodule_reloader = mk_doctestXmodule_reloader_('', 'nn_ns.fileformat.png.simple_reader_writer4png:__doc__', '-ht')
...
#load:
py_adhoc_call   nn_ns.fileformat.png.simple_reader_writer4png   ,load_png_file__mx8src_   :../../python3_src/haskell_src/Framework4Translation-ver5-images/串联同文.png
py_adhoc_call   nn_ns.fileformat.png.simple_reader_writer4png   @load_png_file8pixel_matrix7RGBA4src_   :../../python3_src/haskell_src/Framework4Translation-ver5-images/串联同文.png



#convert{load,dump}:
py_adhoc_call   nn_ns.fileformat.png.simple_reader_writer4png   @convert_png_file__switch01_interlace_method_   :../../python3_src/haskell_src/Framework4Translation-ver5-images/串联同文.png   =None

py_adhoc_call   nn_ns.fileformat.png.simple_reader_writer4png   @convert_png_file__switch01_interlace_method_   :../../python3_src/haskell_src/Framework4Translation-ver5-images/串联同文.png   :../../python3_src/haskell_src/Framework4Translation-ver5-images/tmp-串联同文.png

py_adhoc_call   nn_ns.fileformat.png.simple_reader_writer4png   @convert_png_file__switch01_interlace_method_   :../../python3_src/haskell_src/Framework4Translation-ver5-images/串联同文.png   :../../python3_src/haskell_src/Framework4Translation-ver5-images/tmp-串联同文.png

py_adhoc_call   nn_ns.fileformat.png.simple_reader_writer4png   @convert_png_file__switch01_interlace_method_   :../../python3_src/haskell_src/Framework4Translation-ver5-images/tmp-串联同文.png   :../../python3_src/haskell_src/Framework4Translation-ver5-images/tmp-tmp-串联同文.png
...
__all__
from nn_ns.fileformat.png.simple_reader_writer4png import load_png_file__both_mx8src_and_mx8png_
from nn_ns.fileformat.png.simple_reader_writer4png import dump_png_file__pixel_matrix7RGBA4src_, preprocess__pixel_matrix7RGBA4src_

from nn_ns.fileformat.png.simple_reader_writer4png import BaseError
from nn_ns.fileformat.png.simple_reader_writer4png import ColorType4png, FilterType4filter_method0

from nn_ns.fileformat.png.simple_reader_writer4png import Reader4png, decode_IDAT_
from nn_ns.fileformat.png.simple_reader_writer4png import Writer4png, encode_IDAT_

from nn_ns.fileformat.png.simple_reader_writer4png import *
