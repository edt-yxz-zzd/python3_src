...
'''
BlockDict2 == BlockDict__for_sorted_block_items__ops_biased
...
'''
__all__ = '''
    BlockDict__for_sorted_block_items__ops_biased
    '''.split()

from ..BlockDict.IBlockDict_by_BlockDictOps__ops_biased import \
    IBlockDict_by_BlockDictOps__ops_biased
from .BlockDict__for_sorted_block_items import __doc__ as _doc, BlockDict__for_sorted_block_items as BlockDict1
...
class BlockDict__for_sorted_block_items(
    IBlockDict_by_BlockDictOps__ops_biased, BlockDict1):
    '''
...
BlockDict__for_sorted_block_items__ops_biased = BlockDict2 = BlockDict__for_sorted_block_items


if __name__ == "__main__":
    XXX = BlockDict__for_sorted_block_items__ops_biased
