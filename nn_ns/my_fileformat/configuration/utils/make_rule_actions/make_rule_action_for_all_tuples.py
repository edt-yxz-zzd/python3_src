...
def make_rule_action_for_all_tuples(locals, unit_rules_in_str):
    '''
...
'''
    ...
    basic_make_rule_action_for_all_tuples(inject_to, true_tuple_rules)
...
def basic_make_rule_action_for_all_tuples(inject_to, true_tuple_rules):
    '''
...
'''
    ...
    for name, alternatives in true_tuple_rules:
        ...
        def p_(p, *, indices=indices, tuple=tuple):
            p[0] = tuple(p[i] for i in indices)
