...
def _load():
  ...
  with mk_context4import_stmts_(name7importZqnm4mdl:={}):
    ...
    from seed.tiny_.check import check_subscriptable, check_getitemable, check_callable, check_iterator
        #, is_subscriptable

    from seed.tiny_.check import check_type_le_in, check_type_in, check_type_le, check_type_is, check_tuple__len_le, check_tuple__len_ge, check_tuple__len_eq, check_len_le, check_len_ge, check_len_eq, check_tmay, check_pair, check_either, check_uint, check_imay
    from seed.tiny_.check import check_uint_lt, check_int_ge_lt, check_int_between, check_int_ge, check_int_ge_le, check_uint_le, check_imay_le

    from seed.tiny_.check import icheck_subscriptable, icheck_getitemable, icheck_type_le_in, icheck_type_in, icheck_type_le, icheck_type_is, icheck_tmay, icheck_pair, icheck_either, icheck_uint, icheck_imay, icheck_int_ge, icheck_int_ge_le, icheck_uint_le, icheck_imay_le
