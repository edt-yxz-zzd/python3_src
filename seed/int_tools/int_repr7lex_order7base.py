...
魖数据位元串表达牜词典序牜前置长度
    ...
    魖整数位元串表达牜词典序牜前置长度
        魖整数位元串表达牜词典序牜前置长度牜使用匴整数位元串表达冃前置长度
        魖整数位元串表达牜词典序牜前置长度牜整数零编码为单胞
            魖整数位元串表达牜词典序牜前置长度牜整数零编码为单胞牜使用自然数编码器
    魖自然数位元串表达牜词典序牜前置长度
        魖自然数位元串表达牜词典序牜前置长度牜无首胞牜体胞符型唯一牜使用深入指示符串冃前置长度
        魖自然数位元串表达牜词典序牜前置长度牜使用匴自然数位元串表达冃前置长度
...
魖整数位元串表达牜词典序牜前置长度牜使用匴整数位元串表达冃前置长度
    乸整数位元串表达牜词典序牜前置长度牜使用匴整数位元串表达冃前置长度
魖自然数位元串表达牜词典序牜前置长度牜无首胞牜体胞符型唯一牜使用深入指示符串冃前置长度
    乸自然数位元串表达牜词典序牜前置长度牜无首胞牜体胞符型唯一牜使用深入指示符串冃前置长度
魖自然数位元串表达牜词典序牜前置长度牜使用匴自然数位元串表达冃前置长度
    乸自然数位元串表达牜词典序牜前置长度牜使用匴自然数位元串表达冃前置长度
...
def 自然数讠位元串乊规模纟字母表牜基准版扌(位元串巛趃位元串乊规模纟字母表扌, 规模纟字母表, 自然数, /):
    '(规模纟字母表 -> Iter 位元 -> 位元串) -> 规模纟字母表 -> 自然数 -> 位元串 #大端序#big_endian'
    check_int_ge(2, 规模纟字母表)
    check_int_ge(0, 自然数)
    radix = 规模纟字母表
    u = 自然数
...
def _检查冫符型纟末层屮规模纟字母表纟末层扌(内匴, 符型纟末层屮规模纟字母表纟末层, /):
    check_type_le(tuple, 符型纟末层屮规模纟字母表纟末层)
    if not 2 == len(符型纟末层屮规模纟字母表纟末层):raise TypeError
    check_type_is(bool, 符型纟末层屮规模纟字母表纟末层[0])

    符型讠规模纟字母表牜内匴 = 内匴.符型讠规模纟字母表
    match 符型纟末层屮规模纟字母表纟末层:
        case (False, 符型纟末层):
            check_uint_lt(len(符型讠规模纟字母表牜内匴), 符型纟末层)
        case (True, 规模纟字母表纟末层):
            check_int_ge(2, 规模纟字母表纟末层)
        case bad:
            raise TypeError(bad)

def _求冫符型讠规模纟字母表丶符型纟末层丶规模纟字母表纟末层扌(内匴, 符型纟末层屮规模纟字母表纟末层, /):
    '-> (符型讠规模纟字母表, 符型纟末层, 规模纟字母表纟末层)'
    符型讠规模纟字母表牜内匴 = 内匴.符型讠规模纟字母表
    match 符型纟末层屮规模纟字母表纟末层:
        case (False, 符型纟末层):
            规模纟字母表纟末层 = 符型讠规模纟字母表牜内匴[符型纟末层]
            符型讠规模纟字母表牜外匴 = 符型讠规模纟字母表牜内匴
        case (True, 规模纟字母表纟末层):
            符型纟末层 = len(符型讠规模纟字母表牜内匴)
            符型讠规模纟字母表牜外匴 = (*符型讠规模纟字母表牜内匴, 规模纟字母表纟末层)
        case bad:
            raise TypeError(bad)
    check_int_ge(0, 符型纟末层)
    check_int_ge(2, 规模纟字母表纟末层)
    assert 符型讠规模纟字母表牜外匴[符型纟末层] == 规模纟字母表纟末层
    return (符型讠规模纟字母表牜外匴, 符型纟末层, 规模纟字母表纟末层)



class _魖外匴牜使用内匴冃前置长度(魖数据位元串表达牜词典序牜前置长度):
    __slots__ = ()
    @property
    @abstractmethod
    def _内匴(sf, /):
    ...
    @property
    @abstractmethod
    def 符型纟末层屮规模纟字母表纟末层(sf, /):
        '-> Either   符型纟末层/uint%len(匴整数位元串表达.符型讠规模纟字母表)   规模纟字母表纟末层/uint{>=2}'
    @cached_property
    @override
    def 欤编码无需头胞(sf, /):
        return sf._内匴.欤编码无需头胞
    @cached_property
    @override
    def 欤含无穷大(sf, /):
        return sf._内匴.欤含无穷大
    @cached_property
    def _符型讠规模纟字母表丶符型纟末层丶规模纟字母表纟末层(sf, /):
        '-> (符型讠规模纟字母表, 符型纟末层, 规模纟字母表纟末层)'
        return _求冫符型讠规模纟字母表丶符型纟末层丶规模纟字母表纟末层扌(sf._内匴, sf.符型纟末层屮规模纟字母表纟末层)
    @cached_property
    def 符型纟末层(sf, /):
        '-> uint'
        (符型讠规模纟字母表, 符型纟末层, 规模纟字母表纟末层) = sf._符型讠规模纟字母表丶符型纟末层丶规模纟字母表纟末层
        return 符型纟末层
    @cached_property
    def 规模纟字母表纟末层(sf, /):
        '-> uint{>=2}'
...
class 魖整数位元串表达牜词典序牜前置长度牜使用匴整数位元串表达冃前置长度(_魖外匴牜使用内匴冃前置长度, 魖整数位元串表达牜词典序牜前置长度):
    #同步:魖整数位元串表达牜词典序牜前置长度牜使用匴整数位元串表达冃前置长度
    #同步:魖自然数位元串表达牜词典序牜前置长度牜使用匴自然数位元串表达冃前置长度
    __slots__ = ()
    @property
    @abstractmethod
    def 匴整数位元串表达(sf, /):
    ...
    def 罓表述冫数据讠趃序列纟带符型位元串扌(sf, 数据, /):
        ...
        if 欤无穷大扌(数据) or 数据==0:
            ...
            整数 = 数据
            正整数 = abs(整数)
            位元串纟末层纟绝对值 = sf.自然数讠位元串乊规模纟字母表扌(sf.规模纟字母表纟末层, 正整数)
            带符型位元串纟末层纟绝对值 = (sf.符型纟末层, 位元串纟末层纟绝对值)
            带符型位元串纟末层 = sf.取反冫带符型位元串扌(*带符型位元串纟末层纟绝对值) if 欤负数 else 带符型位元串纟末层纟绝对值
            ls = [带符型位元串纟末层]
            前置长度 = len(位元串纟末层纟绝对值)
            前置带符号长度 = -前置长度 if 欤负数 else 前置长度
        #########
        前置带符号长度, ls
        #########

        趃序列纟带符型位元串牜内匴 = sf.匴整数位元串表达.罓表述冫数据讠趃序列纟带符型位元串扌(前置带符号长度)
        #趃序列纟带符型位元串牜外匴 = 符型外移扌(sf.内符型讠外符型纟匴整数位元串表达, 趃序列纟带符型位元串牜内匴)
        趃序列纟带符型位元串牜外匴 = 趃序列纟带符型位元串牜内匴
            # !! 符型讠规模纟字母表:前缀兼容
        yield from 趃序列纟带符型位元串牜外匴
        yield from ls
        return
    @override
    def 罓解读冫数据巛定型定长前取器扌(sf, 定型定长前取器, /):
        定型定长前取器牜外匴 = 定型定长前取器
        777;del 定型定长前取器
        #定型定长前取器牜内匴 = 乸定型定长前取器牜符型变换(sf.内符型讠外符型纟匴整数位元串表达, 定型定长前取器牜外匴)
        定型定长前取器牜内匴 = 定型定长前取器牜外匴
            # !! 符型讠规模纟字母表:前缀兼容
        前置带符号长度 = sf.匴整数位元串表达.罓解读冫数据巛定型定长前取器扌(定型定长前取器牜内匴)
        欤负数 = 前置带符号长度 < 0
        if 欤无穷大扌(前置带符号长度) or 前置带符号长度==0:
            #无末层
            数据 = 前置带符号长度
        else:
            前置长度 = abs(前置带符号长度)
            定型定长前取器牜或反 = 定型定长前取器牜外匴.取反扌() if 欤负数 else 定型定长前取器牜外匴
            位元串纟末层纟绝对值 = 定型定长前取器牜或反.读取冫位元串牜子表扌(sf.符型纟末层, 前置长度)
            绝对值 = sf.自然数巛位元串牜分离首胞乊规模纟字母表扌(sf.规模纟字母表纟末层, 0, 位元串纟末层纟绝对值)
            整数 = -绝对值 if 欤负数 else 绝对值
            数据 = 整数
        数据
        return 数据
...
class 乸整数位元串表达牜词典序牜前置长度牜使用匴整数位元串表达冃前置长度(魖整数位元串表达牜词典序牜前置长度牜使用匴整数位元串表达冃前置长度):
    ___no_slots_ok___ = True
    def __init__(sf, 匴整数位元串表达, 符型纟末层屮规模纟字母表纟末层, /):
        check_type_le(魖整数位元串表达牜词典序牜前置长度, 匴整数位元串表达)
        _检查冫符型纟末层屮规模纟字母表纟末层扌(匴整数位元串表达, 符型纟末层屮规模纟字母表纟末层)
        sf._opsI = 匴整数位元串表达
        sf._xx = 符型纟末层屮规模纟字母表纟末层
    ##################
    @property
    @override
    def 符型纟末层屮规模纟字母表纟末层(sf, /):
...
check_non_ABC(乸整数位元串表达牜词典序牜前置长度牜使用匴整数位元串表达冃前置长度)
...
class 魖自然数位元串表达牜词典序牜前置长度牜无首胞牜体胞符型唯一牜使用深入指示符串冃前置长度(魖自然数位元串表达牜词典序牜前置长度):
    __slots__ = ()
    @property
    @abstractmethod
    def 规模纟字母表纟唯一符型(sf, /):
    ...
    @abstractmethod
    def 深入指示符(sf, /):
        '-> uint{>=1}{<规模纟字母表纟唯一符型-欤含无穷大}'
    @property
    @abstractmethod
    def 毝正无穷大指示符(sf, /):
        '-> imay 正无穷大指示符/uint{>深入指示符}{<规模纟字母表纟唯一符型}'
    @property
    @abstractmethod
    def 毝固定断头负载长度(sf, /):
        '-> imay 断头负载长度/uint{>=0} # [断头负载长度 == -1+len(位元串纟末层)]'
    ...
    def 欤含无穷大(sf, /):
        sf._自检
        return not sf.毝正无穷大指示符 == -1

    唯一符型 = 0
    @cached_property
    def _自检(sf, /):
        #########
        check_int_ge(-1, sf.毝固定断头负载长度)
        #.if not -1 == (断头负载长度:=sf.毝固定断头负载长度):
        #.    #check_int_ge(1, 断头负载长度)
        #.    check_int_ge(0, 断头负载长度)
        #########
        check_int_ge(1, sf.深入指示符)
        check_int_ge(1+sf.深入指示符, sf.规模纟字母表纟唯一符型)
        check_int_ge(-1, sf.毝正无穷大指示符)
        if not -1 == (正无穷大指示符:=sf.毝正无穷大指示符):
            check_int_ge(1+sf.深入指示符, 正无穷大指示符)
            check_int_ge(1+正无穷大指示符, sf.规模纟字母表纟唯一符型)
        #########
        check_int_ge(2, sf.基数纟末层)
        check_int_ge(sf.基数纟末层, sf.规模纟字母表纟唯一符型)
        #########
    ...
    def 罓表述冫数据讠趃序列纟带符型位元串扌(sf, 数据, /):
        while 1:
            ...
            if not -1 == (断头负载长度:=sf.毝固定断头负载长度):
                步长 = sf.毝步长乊固定断头负载长度
                (长度纟前导串, 负载) = divmod(自然数, 步长)
                位元串纟末层 = sf.自然数讠位元串乊规模纟字母表扌(sf.基数纟末层, 负载)
                assert len(位元串纟末层) <= 1+断头负载长度
                额外 = b'\0'*(1+断头负载长度 -len(位元串纟末层))
                if 长度纟前导串.bit_length() > 22:raise OverflowError
                it = chain(repeat(深入指示符, 长度纟前导串), 额外, 位元串纟末层)
                break
            if 自然数 < 深入指示符:
                it = iter([自然数])
                断头负载长度 = 0
                break
            位元串纟末层 = sf.自然数讠位元串乊规模纟字母表扌(sf.基数纟末层, 自然数)
            assert 位元串纟末层
            额外 = b'\0' if not 位元串纟末层[0] < 深入指示符 else b''
            断头负载长度 = -1 +len(额外) + len(位元串纟末层)
            check_int_ge(1, 断头负载长度)
            长度纟前导串 = 断头负载长度
            it = chain(repeat(深入指示符, 长度纟前导串), 额外, 位元串纟末层)
            break
        it
        位元串 = sf.位元串巛趃位元串乊规模纟字母表扌(sf.规模纟字母表纟唯一符型, it)
        yield (sf.唯一符型, 位元串)
        return
        ...
        while 1:
            if 长度纟前导串 == 0:
                if 首胞 == sf.毝正无穷大指示符:
                    ...
                    break
            if not 首胞 < 深入指示符:
                raise FormatError('未知况态{首胞}', 首胞)
            if not -1 == (断头负载长度:=sf.毝固定断头负载长度):
                步长 = sf.毝步长乊固定断头负载长度
                位元串牜断头 = 定型定长前取器.读取冫位元串牜子表扌(唯一符型, 断头负载长度)
                负载 = sf.自然数巛位元串牜分离首胞乊规模纟字母表扌(sf.基数纟末层, 首胞, 位元串牜断头)
                自然数 = 长度纟前导串*步长 + 负载
                数据 = 自然数
                break
            ...
            check_int_ge(1, 断头负载长度)
            位元串牜断头 = 定型定长前取器.读取冫位元串牜子表扌(唯一符型, 断头负载长度)
            自然数 = sf.自然数巛位元串牜分离首胞乊规模纟字母表扌(sf.基数纟末层, 首胞, 位元串牜断头)
            数据 = 自然数
            break
        return 数据
...
_乸自然数位元串表达牜词典序牜前置长度牜无首胞牜体胞符型唯一牜使用深入指示符串冃前置长度 = mk_named_pseudo_tuple_(__name__, '_乸自然数位元串表达牜词典序牜前置长度牜无首胞牜体胞符型唯一牜使用深入指示符串冃前置长度',  '规模纟字母表纟唯一符型   基数纟末层   深入指示符   毝正无穷大指示符   毝固定断头负载长度')
class 乸自然数位元串表达牜词典序牜前置长度牜无首胞牜体胞符型唯一牜使用深入指示符串冃前置长度(_乸自然数位元串表达牜词典序牜前置长度牜无首胞牜体胞符型唯一牜使用深入指示符串冃前置长度, 魖自然数位元串表达牜词典序牜前置长度牜无首胞牜体胞符型唯一牜使用深入指示符串冃前置长度):
    ___no_slots_ok___ = True
    #def __init__(sf, 规模纟字母表纟唯一符型, 基数纟末层, 深入指示符, 毝正无穷大指示符, 毝固定断头负载长度, /):

    def _check6make_(sf, /):
        sf._自检
    ##################
check_non_ABC(乸自然数位元串表达牜词典序牜前置长度牜无首胞牜体胞符型唯一牜使用深入指示符串冃前置长度)
...
class 魖自然数位元串表达牜词典序牜前置长度牜使用匴自然数位元串表达冃前置长度(_魖外匴牜使用内匴冃前置长度, 魖自然数位元串表达牜词典序牜前置长度):
    #同步:魖整数位元串表达牜词典序牜前置长度牜使用匴整数位元串表达冃前置长度
    #同步:魖自然数位元串表达牜词典序牜前置长度牜使用匴自然数位元串表达冃前置长度
    __slots__ = ()
    @property
    ...
    @override
    def 罓表述冫数据讠趃序列纟带符型位元串扌(sf, 数据, /):
        if 欤正无穷大扌(数据) or 数据==0:
            #无末层
            ls = []
            前置长度 = 数据
        else:
            自然数 = 数据
            位元串纟末层 = sf.自然数讠位元串乊规模纟字母表扌(sf.规模纟字母表纟末层, 自然数)
            带符型位元串纟末层 = (sf.符型纟末层, 位元串纟末层)
            ls = [带符型位元串纟末层]
            前置长度 = len(位元串纟末层)
        #########
        前置长度, ls
        ...
        趃序列纟带符型位元串牜内匴 = sf.匴自然数位元串表达.罓表述冫数据讠趃序列纟带符型位元串扌(前置长度)
        #趃序列纟带符型位元串牜外匴 = 符型外移扌(sf.内符型讠外符型纟匴自然数位元串表达, 趃序列纟带符型位元串牜内匴)
        趃序列纟带符型位元串牜外匴 = 趃序列纟带符型位元串牜内匴
            # !! 符型讠规模纟字母表:前缀兼容
        yield from 趃序列纟带符型位元串牜外匴
        yield from ls
    ...
    def 罓解读冫数据巛定型定长前取器扌(sf, 定型定长前取器, /):
        定型定长前取器牜外匴 = 定型定长前取器
        777;del 定型定长前取器
        #定型定长前取器牜内匴 = 乸定型定长前取器牜符型变换(sf.内符型讠外符型纟匴自然数位元串表达, 定型定长前取器牜外匴)
        定型定长前取器牜内匴 = 定型定长前取器牜外匴
            # !! 符型讠规模纟字母表:前缀兼容
        前置长度 = sf.匴自然数位元串表达.罓解读冫数据巛定型定长前取器扌(定型定长前取器牜内匴)
        if 欤正无穷大扌(前置长度) or 前置长度==0:
            #无末层
            数据 = 前置长度
        else:
            位元串纟末层 = 定型定长前取器牜外匴.读取冫位元串牜子表扌(sf.符型纟末层, 前置长度)
            自然数 = sf.自然数巛位元串牜分离首胞乊规模纟字母表扌(sf.规模纟字母表纟末层, 0, 位元串纟末层)
            数据 = 自然数
        数据
        return 数据
...
class 乸自然数位元串表达牜词典序牜前置长度牜使用匴自然数位元串表达冃前置长度(魖自然数位元串表达牜词典序牜前置长度牜使用匴自然数位元串表达冃前置长度):
    ___no_slots_ok___ = True
    def __init__(sf, 匴自然数位元串表达, 符型纟末层屮规模纟字母表纟末层, /):
        check_type_le(魖自然数位元串表达牜词典序牜前置长度, 匴自然数位元串表达)
        _检查冫符型纟末层屮规模纟字母表纟末层扌(匴自然数位元串表达, 符型纟末层屮规模纟字母表纟末层)
        sf._opsI = 匴自然数位元串表达
        sf._xx = 符型纟末层屮规模纟字母表纟末层
    ##################
    @property
...
check_non_ABC(乸自然数位元串表达牜词典序牜前置长度牜使用匴自然数位元串表达冃前置长度)
...
from seed.int_tools.int_repr7lex_order7base import 乸数据字符串表达牜词典序牜前置长度牜使用匴数据位元串表达, 乸有理数位元串表达牜词典序牜前置长度牜连分数牜无穷大收尾, 乸整数位元串表达牜词典序牜前置长度牜使用匴整数位元串表达冃前置长度, 乸自然数位元串表达牜词典序牜前置长度牜无首胞牜体胞符型唯一牜使用深入指示符串冃前置长度, 乸自然数位元串表达牜词典序牜前置长度牜使用匴自然数位元串表达冃前置长度
    ...
    #乸整数位元串表达牜词典序牜前置长度牜使用匴整数位元串表达冃前置长度(匴整数位元串表达, 符型纟末层屮规模纟字母表纟末层)
    #乸自然数位元串表达牜词典序牜前置长度牜无首胞牜体胞符型唯一牜使用深入指示符串冃前置长度(规模纟字母表纟唯一符型, 基数纟末层, 深入指示符, 毝正无穷大指示符, 毝固定断头负载长度)
    #乸自然数位元串表达牜词典序牜前置长度牜使用匴自然数位元串表达冃前置长度(匴自然数位元串表达, 符型纟末层屮规模纟字母表纟末层)
