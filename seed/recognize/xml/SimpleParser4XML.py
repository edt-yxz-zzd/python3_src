#__all__:goto
r'''[[[
e ../../python3_src/seed/recognize/xml/SimpleParser4XML.py


seed.recognize.xml.SimpleParser4XML
py -m nn_ns.app.debug_cmd   seed.recognize.xml.SimpleParser4XML -x
py -m nn_ns.app.doctest_cmd seed.recognize.xml.SimpleParser4XML:__doc__ -ht
...
假设:极简格式:
    * xxx:没有:文本:<...>之外只能是空格
       ...
       现加入 text_tag
    * xxx:只在属性值字符串中匹配部分引用:没有:引用:『&...;』
        含转义序列:kSemanticVariant="U+4E94&lt;kMatthews"
        grep '&\w*;' /sdcard/0my_files/unzip/unicode14_0/xml/ucd.unihan.flat.xml -o | sort -u
          &lt;
        view /sdcard/0my_files/unzip/py_doc/python-3.12.4-docs-text/library/html.entities.txt
        html.entities.entitydefs
            XHTML 1.0
            -->entitydefs4xhtml_1_0
...
数据标签:只关注:
    ...
    <repertoire>
        <group ...>
            <char cp="07AC" .../>
            <reserved first-cp="07B2" last-cp="07BF" .../>
    <blocks>
        <block first-cp="0000" last-cp="007F" .../>
===
:xml4test:begin
===
...
<ucd xmlns="http://www.unicode.org/ns/2003/ucd/1.0">
   <description>Unicode 14.0.0</description>
   <repertoire>
      <char cp="3400" kCompatibilityVariant="" kRSUnicode="1.4" kIRG_GSource="GKX-0078.01" kIRG_TSource="T6-222C" kIRG_JSource="JA-2121" kIRG_KSource="" kIRG_KPSource="" kIRG_VSource="" kIRG_HSource="" kIRG_USource="" kIRG_MSource="" kIRG_UKSource="" kIRG_SSource="" kCantonese="jau1" kDefinition="(same as U+4E18 丘) hillock or mound" kHanYu="10015.030" kMandarin="qiū" kCangjie="TM" kSemanticVariant="U+4E18" kIRGHanyuDaZidian="10015.030" kIRGKangXi="0078.010" kTotalStrokes="5"/>
... ...
      <char cp="3405" nt="Nu" nv="5" kCompatibilityVariant="" kRSUnicode="4.1" kIRG_GSource="GKX-0081.18" kIRG_TSource="T6-2123" kIRG_JSource="JA-2124" kIRG_KSource="" kIRG_KPSource="" kIRG_VSource="" kIRG_HSource="" kIRG_USource="" kIRG_MSource="" kIRG_UKSource="" kIRG_SSource="" kCantonese="ng5" kDefinition="(an ancient form of U+4E94 五) five" kHanYu="10031.040" kMandarin="wǔ" kCihaiT="47.101" kCowles="3772" kMatthews="7187" kOtherNumeric="5" kPhonetic="954 1156" kCangjie="K" kSemanticVariant="U+4E94&lt;kMatthews" kIRGHanyuDaZidian="10031.040" kIRGKangXi="0081.180" kRSAdobe_Japan1_6="C+15387+3.1.1 C+15387+4.1.1" kTotalStrokes="2" kStrange="B:U+3128"/>
... ...
... ...
... ...
      <char cp="3134A" kCompatibilityVariant="" kRSUnicode="214.8" kIRG_GSource="" kIRG_TSource="T13-3159" kIRG_JSource="" kIRG_KSource="" kIRG_KPSource="" kIRG_VSource="" kIRG_HSource="" kIRG_USource="" kIRG_MSource="" kIRG_UKSource="" kIRG_SSource="" kTotalStrokes="22"/>
   </repertoire>
</ucd>
===
:xml4test4flat:end
...
py_adhoc_call   seed.recognize.xml.SimpleParser4XML   ,parse_xml__ipath --encoding:u8   :/sdcard/0my_files/unzip/unicode14_0/xml/ucd.nounihan.grouped.xml  +to_strip_gap_txt +to_drop_space_gap_txt | more
...
du -h /sdcard/0my_files/tmp/out4py/SimpleParser4XML..14_0.ucd.nounihan.grouped.xml.out.txt
    7M/all_layer <-- 6.5M/top_layer <-- 5.1M/原文件


py_adhoc_call   seed.recognize.xml.SimpleParser4XML   ,_test_    +to_strip_gap_txt +to_drop_space_gap_txt --converter4OrderedDict=dict  | more
py_adhoc_call   seed.recognize.xml.SimpleParser4XML   ,_test_    +to_strip_gap_txt +to_drop_space_gap_txt --converter4OrderedDict=dict  | more
py_adhoc_call   seed.recognize.xml.SimpleParser4XML   @stable_repr__expand_all_layer__noindent._test_    +to_strip_gap_txt +to_drop_space_gap_txt --converter4OrderedDict=dict
...
######################
######################
py_adhoc_call   seed.recognize.xml.SimpleParser4XML   @stable_repr__F__i0__d5._test4flat_    +to_strip_gap_txt +to_drop_space_gap_txt --converter4OrderedDict=dict

######################
py_adhoc_call   seed.recognize.xml.SimpleParser4XML   @stable_repr__F__i0__d5.parse_xml__ipath --encoding:u8   :/sdcard/0my_files/unzip/unicode14_0/xml/ucd.unihan.flat.xml  +to_strip_gap_txt +to_drop_space_gap_txt --converter4OrderedDict=dict  > ~/my_tmp/out4py/SimpleParser4XML..14_0.ucd.unihan.flat.xml.out.txt
view /sdcard/0my_files/tmp/out4py/SimpleParser4XML..14_0.ucd.unihan.flat.xml.out.txt
du -h /sdcard/0my_files/unzip/unicode14_0/xml/ucd.unihan.flat.xml
    45M
du -h /sdcard/0my_files/tmp/out4py/SimpleParser4XML..14_0.ucd.unihan.flat.xml.out.txt
    55M/i0_d5 <-- 45M/原文件

######################
but literal_eval&eval fail to load /sdcard/0my_files/tmp/out4py/SimpleParser4XML..14_0.ucd.unihan.flat.xml.out.txt
    now ++pickle_dump8show

py_adhoc_call   seed.recognize.xml.SimpleParser4XML   @pickle_dump8show._test4flat_    +to_strip_gap_txt +to_drop_space_gap_txt --converter4OrderedDict=dict
    『stable_repr__F__i0__d5.』-->『pickle_dump8show.』
######################
py_adhoc_call   seed.recognize.xml.SimpleParser4XML   @pickle_dump8show.parse_xml__ipath --encoding:u8   :/sdcard/0my_files/unzip/unicode14_0/xml/ucd.unihan.flat.xml  +to_strip_gap_txt +to_drop_space_gap_txt --converter4OrderedDict=dict  > ~/my_tmp/out4py/SimpleParser4XML..14_0.ucd.unihan.flat.xml.pickle.dump
    『stable_repr__F__i0__d5.』-->『pickle_dump8show.』
    『.out.txt』-->『.pickle.dump』
du -h /sdcard/0my_files/tmp/out4py/SimpleParser4XML..14_0.ucd.unihan.flat.xml.pickle.dump
    49M/pickle <-- 45M/原文件
######################
...
class SimpleParser4XML:
    def __init__(sf, /, *, turnon__entitydefs4xhtml_1_0=False):
        check_type_is(bool, turnon__entitydefs4xhtml_1_0)
        sf._b_ref = turnon__entitydefs4xhtml_1_0
    ...
    def parse_xml__PeekableIterator(sf, it, /, *, to_strip_gap_txt=False, to_drop_space_gap_txt=False, converter4OrderedDict=None):
        #, **kwds4parse=[def]=to_strip_gap_txt, to_drop_space_gap_txt, converter4OrderedDict
        ...
        if converter4OrderedDict is None:
            converter4OrderedDict = echo
        check_callable(converter4OrderedDict)
        ...
        try:
            for u, tag in enumerate(sf._parse_tags(it)):
                ...
                tag
                sf._update_tagss(tagss, tag, case4v, converter4OrderedDict)
            if not len(tagss) == 1:raise ParseFail
        except ParseFail:
            raise ParseFail(tagss)
        [whole_tags6toplevel] = tagss
        return whole_tags6toplevel
    def _update_tagss(sf, tagss, tag, c, converter4OrderedDict, /):
        if c == 'T':
            gap_text_tag = tag
            ...
            nm2s = converter4OrderedDict(nm2s)
    ...
    def _parse_property_value(sf, it, /):
        ...
        if not try_skip_prefix_('"', it):
            raise ParseFail
        #return s
        if sf._b_ref and '&' in s:
            s = unescape__entitydefs4xhtml_1_0(s)
        return s


    @property
    def _is_char4gap(sf, /):
        return sf._is_char4gap__allow_ref if sf._b_ref else sf._is_char4gap__no_ref
    def _is_char4gap__no_ref(sf, c, /):
        return not c in '<>&'
    def _is_char4gap__allow_ref(sf, c, /):
        return not c in '<>'
...
simple_parser4XML = SimpleParser4XML(turnon__entitydefs4xhtml_1_0=True)
...
def _mk__xml4test4flat_():
    a = ':xml4test4flat:begin'
    b = ':xml4test4flat:end'
    s = __doc__
    return strip_text_by_marker_pair(s, a, b)
...
def _mk__xml4test_():
    ...
    xml4test = _s_
    return xml4test
def _test_(**kwds4parse):
    xml4test = _mk__xml4test_()
    it = echo_or_mk_PeekableIterator(xml4test)
    return parse_xml__PeekableIterator(it, **kwds4parse)
def _test4flat_(**kwds4parse):
    xml4test4flat = _mk__xml4test4flat_()
    it = echo_or_mk_PeekableIterator(xml4test4flat)
    return parse_xml__PeekableIterator(it, **kwds4parse)
...
if __name__ == "__main__":
    ...
__all__
from seed.recognize.xml.SimpleParser4XML import ParseFail
from seed.recognize.xml.SimpleParser4XML import parse_xml__ipath, parse_xml__ifile, parse_xml__PeekableIterator
from seed.recognize.xml.SimpleParser4XML import *
