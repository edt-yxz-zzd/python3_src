...
_大列表纟测试用靶值:
    ...
    py_adhoc_call   seed.math.power.addition_chain.shortest.may_optimal_addition_chain5target_uint7generally_solved_small_step_cases   ,趃测试冫构造冫鬽最短加链巛靶值纟已知阳爻模板扌  =True #测试用靶值列表牜大
    ==>>:摘选:40,42:
...
>>> [8295 == 0b10000001100111 == 2**13+2**6+2**5+2**2+2**1+2**0]
[True]
>>> 靶值讠婪溟链牜递归最短牜任意扌(8295)
(1, 2, 4, 8, 16, 32, 33, 65, 130, 260, 520, 553, 1106, 2212, 2765, 5530, 8295)
>>> 严序加链讠最短缩写文本纟递归婪溟链扌(靶值讠婪溟链牜递归最短牜任意扌(8295), fmt_case='dnzw_str')
'[-^5-1^5----4-^2-^1]'

head -n 8295 /sdcard/0my_files/tmp/out4py/seed.math.power.addition_chain.shortest.search_star_chain7recursive_shortest..枚举生成冫文件冃靶值讠升列纟次大数牜递归最短丶文件冃靶值讠次大数讠首尾加星链牜递归最短扌.-1.ver2.out.txt | tail -n 1
    ==>>:s_8295
>>> s_8295 = '[#BB3+B-Cz-JF-Io-RR-SL-Fn-CG],[-^1-^1-1^1-^3-1^3-----5-1]:[-^1-^2-^3-1^3-----5-1],[-^1-^1-1^1-^5-1^5---3-1]:[-^1-^2-^5-1^5---3-1],[-^1-^3-1^3-----5-1-^1-1^1]:[-^1-^3-1^3------6-^1-1^1],[-^1-1^1-^3-1^3-----5-1-^1]:[-^2-^3-1^3------6-^1],[-^1-^3-1^3-----5-1-^2]:[-^1-^3-1^3------6-^2],[-^1-^1-1^1-^5-1^5----4]:[-^1-^2-^5-1^5----4],[-^1-^1-1^1-^3-1^3------6]:[-^1-^2-^3-1^3------6]'
>>> r = 解读冫文本冃次大数讠首尾加链扌(s_8295, ver=2)
>>> 次大数讠首尾加链纟八二九五 = (
... {4215: ((1, 2, 3, 6, 9, 15, 30, 60, 120, 135, 255, 510, 1020, 2040, 4080, 4215, 8295), (1, 2, 3, 6, 12, 15, 30, 60, 120, 135, 255, 510, 1020, 2040, 4080, 4215, 8295))
... ,4395: ((1, 2, 3, 6, 9, 15, 30, 60, 120, 240, 480, 495, 975, 1950, 3900, 4395, 8295), (1, 2, 3, 6, 12, 15, 30, 60, 120, 240, 480, 495, 975, 1950, 3900, 4395, 8295))
... ,4977: ((1, 2, 3, 6, 12, 24, 27, 51, 102, 204, 408, 816, 843, 1659, 3318, 4977, 8295), (1, 2, 3, 6, 12, 24, 27, 51, 102, 204, 408, 816, 1632, 1659, 3318, 4977, 8295))
... ,5530: ((1, 2, 3, 5, 10, 20, 40, 45, 85, 170, 340, 680, 1360, 1405, 2765, 5530, 8295), (1, 2, 4, 5, 10, 20, 40, 45, 85, 170, 340, 680, 1360, 2720, 2765, 5530, 8295))
... ,6636: ((1, 2, 3, 6, 12, 24, 27, 51, 102, 204, 408, 816, 843, 1659, 3318, 6636, 8295), (1, 2, 3, 6, 12, 24, 27, 51, 102, 204, 408, 816, 1632, 1659, 3318, 6636, 8295))
... ,7800: ((1, 2, 3, 6, 9, 15, 30, 60, 120, 240, 480, 495, 975, 1950, 3900, 7800, 8295), (1, 2, 3, 6, 12, 15, 30, 60, 120, 240, 480, 495, 975, 1950, 3900, 7800, 8295))
... ,8160: ((1, 2, 3, 6, 9, 15, 30, 60, 120, 135, 255, 510, 1020, 2040, 4080, 8160, 8295), (1, 2, 3, 6, 12, 15, 30, 60, 120, 135, 255, 510, 1020, 2040, 4080, 8160, 8295))
... })
>>> r == (8295, 次大数讠首尾加链纟八二九五)
True
>>> 最大次大数纟八二九五 = max(次大数讠首尾加链纟八二九五)
>>> 加星链牜递归最短牜右侧最大纟八二九五 = 次大数讠首尾加链纟八二九五[最大次大数纟八二九五][-1]
>>> 加星链牜递归最短牜右侧最大纟八二九五
(1, 2, 3, 6, 12, 15, 30, 60, 120, 135, 255, 510, 1020, 2040, 4080, 8160, 8295)
>>> 严序加链讠最短缩写文本纟递归婪溟链扌(加星链牜递归最短牜右侧最大纟八二九五, fmt_case='dnzw_str')
'[-^1-^2-^3-1^3------6]'




比较:第40模板@8295、第42模板@33102&66126
>>> 严序加链讠最短缩写文本纟递归婪溟链扌((1, 2, 4, 8, 9, 17, 34, 68, 136, 272, 544, 553, 1106, 2212, 2765, 5530, 8295), fmt_case='dnzw_str')
'[-^3-1^3------6-^2-^1]'
>>> 严序加链讠最短缩写文本纟递归婪溟链扌((1, 2, 4, 8, 9, 17, 26, 43, 86, 172, 344, 688, 1376, 2752, 5504, 11008, 11034, 22068, 33102), fmt_case='dnzw_str')
'[-^3-1^3-1-1---------9-^1]'
>>> 严序加链讠最短缩写文本纟递归婪溟链扌((1, 2, 4, 8, 9, 17, 26, 43, 86, 172, 344, 688, 1376, 2752, 5504, 11008, 22016, 22042, 44084, 66126), fmt_case='dnzw_str')
'[-^3-1^3-1-1----------10-^1]'


head -n 33102 /sdcard/0my_files/tmp/out4py/seed.math.power.addition_chain.shortest.search_star_chain7recursive_shortest..枚举生成冫文件冃靶值讠升列纟次大数牜递归最短丶文件冃靶值讠次大数讠首尾加星链牜递归最短扌.-1.ver2.out.txt | tail -n 1
    ==>>:s_33102
>>> s_33102 = '[#EUq+B-BEJ-CIT-kF],[-^1-^8-1^8-1-1---3-1],[-^3-1^3-1-1--------8-1-^1]:[-^3-1^3-1-1---------9-^1],[-^1-^8-1^8-1-1----4]'
>>> r = 解读冫文本冃次大数讠首尾加链扌(s_33102, ver=2)
>>> 次大数讠首尾加链纟三三一零二 = (
... {17706: ((1, 2, 3, 6, 12, 24, 48, 96, 192, 384, 768, 771, 1539, 2310, 3849, 7698, 15396, 17706, 33102),)
... ,22068: ((1, 2, 4, 8, 9, 17, 26, 43, 86, 172, 344, 688, 1376, 2752, 5504, 5530, 11034, 22068, 33102), (1, 2, 4, 8, 9, 17, 26, 43, 86, 172, 344, 688, 1376, 2752, 5504, 11008, 11034, 22068, 33102))
... ,30792: ((1, 2, 3, 6, 12, 24, 48, 96, 192, 384, 768, 771, 1539, 2310, 3849, 7698, 15396, 30792, 33102),)
... })
>>> r == (33102, 次大数讠首尾加链纟三三一零二)
True

head -n 66126 /sdcard/0my_files/tmp/out4py/seed.math.power.addition_chain.shortest.search_star_chain7recursive_shortest..枚举生成冫文件冃靶值讠升列纟次大数牜递归最短丶文件冃靶值讠次大数讠首尾加星链牜递归最短扌.-1.ver2.out.txt | tail -n 1
    ==>>:s_66126
>>> s_66126 = '[#Ioq+B-CIJ-EQT-BIF],[-^1-^9-1^9-1-1---3-1],[-^3-1^3-1-1---------9-1-^1]:[-^3-1^3-1-1----------10-^1],[-^1-^9-1^9-1-1----4]'
>>> r = 解读冫文本冃次大数讠首尾加链扌(s_66126, ver=2)
>>> 次大数讠首尾加链纟六六一二六 = (
... {35370: ((1, 2, 3, 6, 12, 24, 48, 96, 192, 384, 768, 1536, 1539, 3075, 4614, 7689, 15378, 30756, 35370, 66126),)
... ,44084: ((1, 2, 4, 8, 9, 17, 26, 43, 86, 172, 344, 688, 1376, 2752, 5504, 11008, 11034, 22042, 44084, 66126), (1, 2, 4, 8, 9, 17, 26, 43, 86, 172, 344, 688, 1376, 2752, 5504, 11008, 22016, 22042, 44084, 66126))
... ,61512: ((1, 2, 3, 6, 12, 24, 48, 96, 192, 384, 768, 1536, 1539, 3075, 4614, 7689, 15378, 30756, 61512, 66126),)
... })
>>> r == (66126, 次大数讠首尾加链纟六六一二六)
True

head -n 66204 /sdcard/0my_files/tmp/out4py/seed.math.power.addition_chain.shortest.search_star_chain7recursive_shortest..枚举生成冫文件冃靶值讠升列纟次大数牜递归最短丶文件冃靶值讠次大数讠首尾加星链牜递归最短扌.-1.ver2.out.txt | tail -n 1
    ==>>:s_66204
>>> s_66204 = '[#IFO+B-kF-CIT-EQn-BIL],[-^1-^8-1^8-1-1---3-1-]:[-^1-^8-1^8-1-1----4-],[-^1--^8-1^8-1-1---3-1]:[--^1-^8-1^8-1-1---3-1],[-^3-1^3-1-1--------8-1--^1]:[--^3-1^3-1-1---------9-^1],[-^1--^8-1^8-1-1----4]:[--^1-^8-1^8-1-1----4]'
>>> r = 解读冫文本冃次大数讠首尾加链扌(s_66204, ver=2)
>>> 次大数讠首尾加链纟六六二零四 = (
... {33102: ((1, 2, 3, 6, 12, 24, 48, 96, 192, 384, 768, 771, 1539, 2310, 3849, 7698, 15396, 17706, 33102, 66204), (1, 2, 3, 6, 12, 24, 48, 96, 192, 384, 768, 771, 1539, 2310, 3849, 7698, 15396, 30792, 33102, 66204))
... ,35412: ((1, 2, 3, 6, 12, 24, 48, 96, 192, 384, 768, 1536, 1542, 3078, 4620, 7698, 15396, 30792, 35412, 66204), (1, 2, 4, 6, 12, 24, 48, 96, 192, 384, 768, 1536, 1542, 3078, 4620, 7698, 15396, 30792, 35412, 66204))
... ,44136: ((1, 2, 4, 8, 9, 17, 26, 43, 86, 172, 344, 688, 1376, 2752, 5504, 5530, 11034, 22068, 44136, 66204), (1, 2, 4, 8, 16, 18, 34, 52, 86, 172, 344, 688, 1376, 2752, 5504, 11008, 22016, 22068, 44136, 66204))
... ,61584: ((1, 2, 3, 6, 12, 24, 48, 96, 192, 384, 768, 1536, 1542, 3078, 4620, 7698, 15396, 30792, 61584, 66204), (1, 2, 4, 6, 12, 24, 48, 96, 192, 384, 768, 1536, 1542, 3078, 4620, 7698, 15396, 30792, 61584, 66204))
... })
>>> r == (66204, 次大数讠首尾加链纟六六二零四)
True
...
=> 66204:无用
33102,66126 ==>>:
比较:s_8295,s_33102,s_66204
s_8295.负载 == '[-^1-^1-1^1-^3-1^3-----5-1]:[-^1-^2-^3-1^3-----5-1],[-^1-^1-1^1-^5-1^5---3-1]:[-^1-^2-^5-1^5---3-1],[-^1-^3-1^3-----5-1-^1-1^1]:[-^1-^3-1^3------6-^1-1^1],[-^1-1^1-^3-1^3-----5-1-^1]:[-^2-^3-1^3------6-^1],[-^1-^3-1^3-----5-1-^2]:[-^1-^3-1^3------6-^2],[-^1-^1-1^1-^5-1^5----4]:[-^1-^2-^5-1^5----4],[-^1-^1-1^1-^3-1^3------6]:[-^1-^2-^3-1^3------6]'
s_33102.负载 == '[-^1-^8-1^8-1-1---3-1],[-^3-1^3-1-1--------8-1-^1]:[-^3-1^3-1-1---------9-^1],[-^1-^8-1^8-1-1----4]'
s_66126.负载 == '[-^1-^9-1^9-1-1---3-1],[-^3-1^3-1-1---------9-1-^1]:[-^3-1^3-1-1----------10-^1],[-^1-^9-1^9-1-1----4]'
